// app/api/generate-transfer-order-pdf/route.js
import { pdf } from '@react-pdf/renderer';
import TransferOrderPDF from '@/app/components/product/pdf/TransferOrderPDF';
...
export async function POST(req) {
  try {
    ...
    // Generate PDF
    const pdfBuffer = await pdf(<TransferOrderPDF data={data} />).toBuffer();
