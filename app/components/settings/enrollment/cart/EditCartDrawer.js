...
export default function EditCartDrawer({
  isGrantAccessOpen,
    ...
    >
      ...
      <div className="font-semibold">
        ...
        <p className="border-0 border-b-2 pb-3">
          <span className="text-neutral-900 text-xl px-6">Edit access</span>
        </p>
        ...
        <form className="space-y-8 px-6 pt-6" onSubmit={handleSubmit(onSubmit)}>
          ...
          <p className="flex flex-col">
            <span className="text-neutral-900 text-lg">Edit principals</span>
