      ...
      <div className='max-w-screen-2xl px-6 2xl:px-0 mx-auto'>
        ...
        <div className='max-w-screen-xl mx-auto pt-3 sticky top-0 z-10 bg-gray-50'>
          <div className='flex items-center justify-between'>
            <h3 className='w-full font-semibold text-lg lg:text-2xl text-neutral-600'>Offer Configuration</h3>
            ...
            <div className='grid grid-cols-1 lg:col-span-5 gap-8 mt-3 py-3 h-fit'>
              ...
              <div className='flex flex-col gap-4 bg-[#ffffff] drop-shadow p-5 md:p-7 rounded-lg h-fit'>
                ...
                <div>
                  ...
                  <input id='offerTitle' placeholder='Enter Offer Title'  {...register("offerTitle", { required: true })} className="h-11 w-full rounded-lg border-2 border-[#ededed] px-3 text-xs text-neutral-700 outline-none placeholder:text-neutral-400 focus:border-[#F4D3BA] focus:bg-white md:text-[13px] font-semibold" type="text" />
              ...
              <div className='flex flex-col gap-4 bg-[#ffffff] drop-shadow p-5 md:p-7 rounded-lg h-fit'>
                ...
                <div>
                  ...
                  {dateError && (
                    <p className="text-left pt-2 text-red-500 font-semibold text-xs">Please select Offer Expire Date.</p>
                  )}
                </div>
