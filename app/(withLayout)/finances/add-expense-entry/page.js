...
const AddExpenseEntry = () => {
  ...
  const availableSubSubCategories =
    availableSubCategories.find(sc => sc.name === selectedSubCategory)?.subSubCategories || [];
  ...
  if (isExpenseCategoryPending) return <Loading />;
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <div className='max-w-screen-lg mx-auto p-6 flex flex-col gap-4'>
          ...
          <div className='flex flex-col gap-4 bg-[#ffffff] drop-shadow p-5 md:p-7 rounded-lg w-full'>
            ...
            {/* Expense Category */}
            <div>
              <label htmlFor="expenseCategory" className="block font-semibold text-neutral-600 mb-2">
              ...
              <select
                ...
                className="w-full border border-gray-300 rounded-lg px-3 py-2 text-neutral-700 bg-white shadow-sm transition-all duration-200 focus:outline-none focus:ring-1 focus:ring-[#F4D3BA] focus:border-[#F4D3BA]"
              >
            ...
            {selectedCategory && availableSubCategories.length > 0 && (
              <div>
                <label htmlFor="subCategory" className="block font-semibold text-neutral-600 mb-2">
            ...
            {selectedSubCategory && availableSubSubCategories.length > 0 && (
              <div>
                <label htmlFor="subSubCategory" className="block font-semibold text-neutral-600 mb-2">
                ...
                {errors.subSubCategory && (
                  <p className="text-xs text-red-500 mt-1">{errors.subSubCategory.message}</p>
                )}
              </div>
            )}
          ...
          <div className='flex flex-col gap-4 bg-[#ffffff] drop-shadow p-5 md:p-7 rounded-lg w-full'>
            ...
            {/* Paid To */}
            <div>
              <label htmlFor='paidTo' className="flex justify-start font-semibold text-neutral-500 text-sm pb-2">Paid To <span className="text-red-600 pl-1">*</span></label>
              <input
                id={`paidTo`}
                ...
                type="text"
              />
              {errors.paidTo && <p className="text-left pt-2 text-red-500 font-semibold text-xs">{errors.paidTo.message}</p>}
            </div>
